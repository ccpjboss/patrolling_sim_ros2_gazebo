...
bool GotoStartPosSrvCallback(const std::shared_ptr<patrolling_sim_msgs::srv::GoToStartPosSrv::Request> Req, std::shared_ptr<patrolling_sim_msgs::srv::GoToStartPosSrv::Response> Rep)
{
...
int main(int argc, char **argv)
{
    ...
    rclcpp::Service<patrolling_sim_msgs::srv::GoToStartPosSrv>::SharedPtr service 
        = n_ptr->create_service<patrolling_sim_msgs::srv::GoToStartPosSrv>("go_to_start_pos_srv", &GotoStartPosSrvCallback);
